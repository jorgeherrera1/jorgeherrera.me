...
I would also say that Claude Code's planning mode is also better. It does not _automatically_ create the file with the spec/tasks, but does a  better job at planning, that it's almost unnecessary to create the file anyway.
